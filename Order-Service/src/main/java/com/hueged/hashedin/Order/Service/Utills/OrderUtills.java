package com.hueged.hashedin.Order.Service.Utills;
...
public class OrderUtills {
	...
	public ResponseEntity<ResponseMapper> responseEntityForDelete(Object object) {
		ResponseMapper responseMapper;
		if (object == null) {
			responseMapper = new ResponseMapper("RESOO1", "Data deleted successfully");
			responseMapper.addValidations("RESOO1", "Data deleted successfully");
		} else {
			responseMapper = new ResponseMapper(RES_CODE_SUCCESS, DATA_FETCH_SUCCESSFULLY);
			responseMapper.addValidations(RES_CODE_FET001, DATA_FETCH_SUCCESSFULLY);
		}
